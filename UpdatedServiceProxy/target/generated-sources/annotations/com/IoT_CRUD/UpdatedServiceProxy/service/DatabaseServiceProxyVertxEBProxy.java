...
public class DatabaseServiceProxyVertxEBProxy implements DatabaseServiceProxy {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public DatabaseServiceProxyVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public DatabaseServiceProxyVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void addDevice(JsonObject deviceData, Handler<AsyncResult<String>> resultHandler){
    ...
    _json.put("deviceData", deviceData);
  ...
  public void getDevice(String deviceId, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.getHeaders().set("action", "getDevice");
